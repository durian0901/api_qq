...
require('dotenv').config();  //引入dotenv套件    官方要求寫法

//接收json格式
app.use(express.json());  
app.use(express.urlencoded({extends: false}));  //避免網址有特殊字元
...
//官方就是這樣寫的    :)
app.use(session({
        secret:process.env.APP_KEY,    //設定相關資料  預設指令
        resave: false,
...
app.use('/api',indexRouter)   //轉移到index.js
